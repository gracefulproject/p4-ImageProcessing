...
// Due to profiler IP-tag usage
#define SDP_TAG_REPLY			5
#define SDP_UDP_REPLY_PORT		21000
#define SDP_HOST_IP				0x02F0A8C0	// 192.168.240.2, dibalik!
#define SDP_TAG_RESULT			6
#define SDP_UDP_RESULT_PORT		21001
#define SDP_TAG_DEBUG           7
#define SDP_UDP_DEBUG_PORT      21002
